    ...
    const generateImage = async () => {
        if (form.prompt) {
            try {
                ...
                console.log("data in generate image is ", data);
                setForm({
                    ...form, photo: `data:image/jpg;base64,${data.photo}`
                });
                // setForm({
    ...
    return (
        <section className='max-w-7xl mx-auto'>
            <div>
                ...
                <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Create imaginative and visually stunning images thrpugh OpenAI APIs and share them with the community</p>
            </div>
